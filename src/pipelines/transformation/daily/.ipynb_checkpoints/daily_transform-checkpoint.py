...
def daily_transform(symbol,currency):
    df = parquet_to_df(client_minio = client_minio,timeframe = 'daily',crypto = symbol,schema = schema)
...
def main():
    ...
    for symbol in cryptos:
        try:
            daily_transform(symbol = symbol,currency = "USDT")
