...
def minio_pipeline_daily(symbol):
    ...
    data = get_data_daily(symbol = symbol,interval = '1d',start_date = "01-01-2019",end_date = "01-01-2024")
    df_daily = spark_df_daily(data,columns)
    upload_minio(minio_url = 'localhost:9000',minio_user = MINIO_USER ,minio_password = MINIO_PASSWORD ,symbol = symbol ,bucket_name = 'binancedata',timeframe='Daily',df = df_daily)
